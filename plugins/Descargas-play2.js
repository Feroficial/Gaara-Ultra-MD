...
🌟 ¡Disfruta tus videos con 𝙂𝙊𝙆𝙐-𝘽𝙇𝘼𝘾𝙆
    `.trim(), m, ctxWarn);
  }

  try {
    await conn.reply(m.chat, '⚡️🎬 𝙂𝙊𝙆𝙐-𝘽𝙇𝘼𝘾𝙆 está buscando tu video...', m, ctxOk);
